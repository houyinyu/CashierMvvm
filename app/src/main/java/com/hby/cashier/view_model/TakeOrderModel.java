...
public class TakeOrderModel extends BaseViewModel<DemoRepository> {
    ...
    public class UIChangeObservable {
        ...
        //右侧作废监听
        public SingleLiveEvent voidEvent = new SingleLiveEvent<>();
        //右侧收银监听
        public SingleLiveEvent keepCashierEvent = new SingleLiveEvent<>();
        //右侧结算监听
        public SingleLiveEvent settlementEvent = new SingleLiveEvent<>();
        //右侧打印监听
        public SingleLiveEvent printEvent = new SingleLiveEvent<>();
    }

    public TakeOrderModel(@NonNull Application application) {
        super(application);
    }

    public TakeOrderModel(@NonNull Application application, DemoRepository repository) {
    ...
    //左侧开始时间选择监听
    public BindingCommand takeOrderStartTimeClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
    ...
    //左侧结束时间选择监听
    public BindingCommand takeOrderEndTimeClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
    ...
    //左侧搜索监听
    public BindingCommand takeOrderSearchClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
            uc.searchEvent.call();
        }
    ...
    //右侧作废监听
    public BindingCommand voidClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
            uc.voidEvent.call();
        }
    ...
    public BindingCommand settlementClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
            uc.settlementEvent.call();
        }
    });
    //右侧打印
    public BindingCommand printClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
            uc.printEvent.call();
        }
